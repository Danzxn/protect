            ...
            <div style="padding:18px 20px;display:flex;gap:16px;align-items:flex-start;">
                ...
                <div style="flex:1;">
                    ...
                    <div style="display:flex;gap:6px;flex-wrap:wrap;align-items:center;font-family:'JetBrains Mono',monospace;">
                        ...
                        <span style="background:#fafafa;color:#0a0a0a;border:1.5px solid #0a0a0a;padding:3px 9px;font-size:10px;font-weight:900;letter-spacing:1px;">@danzxntesti3</span>
...
sed -i "s|@danzxntesti3|${CONTACT_TELEGRAM_2}|g" "$INDEX_FILE" 2>/dev/null || true
